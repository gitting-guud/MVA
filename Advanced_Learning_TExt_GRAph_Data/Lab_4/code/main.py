...
path_root = "D:/MVA/Altegrad/Lab_4/for_moodle/"
...
if not is_prod:
    ...
    for elt in to_test:
        res, sco, source_nl_clean_tok, target_nl = model.predict(elt)
        print('= = = = = \n','%s -> %s' % (elt,res))
#        
#        fig = plt.figure(figsize=(12,9))
#        ax = fig.add_subplot(111)
#        cax = ax.matshow(sco[0].cpu().detach().numpy())
#        fig.colorbar(cax)
#        ax.set_xticklabels(['']+target_nl, rotation = 90)
#        ax.set_yticklabels([""]+source_nl_clean_tok)
