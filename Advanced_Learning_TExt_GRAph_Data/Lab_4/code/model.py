...
class seq2seqAtt(nn.Module):
    ...
    def forward(self,target_h,source_hs):
        ...
        concat_output = torch.tanh(self.ff_concat(torch.cat((target_h_rep, source_hs), 2)))
...
class Decoder(nn.Module):
    ...
    def forward(self, input, source_context, h):
        ...
        tilde_h = torch.tanh(self.ff_concat(torch.cat((source_context, h), 2)))
...
#         = = = decoder part (one timestep at a time)  = = =
        ...
        while True:
            ...
            if self.do_att:
                ...
                if pos == 0 :
                    ...
                    scores = torch.cat((scores,score),1)
            ...
            values, indices = prediction.topk(1)
            
            target_input =  indices.squeeze(2)
    ...
    def sourceNl_to_ints(self,source_nl):
        ...
        return source_ints, source_nl_clean_tok
    ...
    def predict(self,source_nl):
        source_ints, source_nl_clean_tok = self.sourceNl_to_ints(source_nl)
        ...
        return ' '.join(target_nl), Scores, source_nl_clean_tok, target_nl
