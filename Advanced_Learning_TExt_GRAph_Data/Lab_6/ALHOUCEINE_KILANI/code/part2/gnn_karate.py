...
def train(epoch):
    ...
    dico["loss_train"].append(loss_train.item())
    dico["acc_train"].append(acc_train.item())
...
plt.plot(range(epochs), dico["loss_train"], label = "loss")
plt.plot(range(epochs), dico["acc_train"], label = "accuracy")
plt.legend()
plt.xlabel("Epoch")
plt.ylabel("%")