...
#            gray_face = cv2.equalizeHist(gray_face)
    ...
    # hard or soft HFS
    rlabels, unlabeled_ind = soft_hfs(images, mlabels, c_l, c_u, laplacian_regularization, var, eps, k, laplacian_normalization)
#    rlabels = hard_hfs(images, mlabels, laplacian_regularization, var, eps, k, laplacian_normalization)
    ...
    print("Acc: {}".format(np.equal(rlabels[unlabeled_ind], labels[unlabeled_ind]).mean()))
    plt.show()
...
#            gray_face = cv2.equalizeHist(gray_face)
    ...
    rlabels, unlabeled_ind = soft_hfs(images, Y_masked, c_l, c_u, laplacian_regularization, var, eps, k, laplacian_normalization)
#    rlabels = hard_hfs(images, mlabels, laplacian_regularization, var, eps, k, laplacian_normalization)
