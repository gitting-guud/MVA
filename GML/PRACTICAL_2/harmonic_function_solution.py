...
def hard_vs_soft_hfs():
    ...
    soft_labels, unlabeled_ind = soft_hfs(X, Y_masked, c_l, c_u, laplacian_regularization, var, eps, k, laplacian_normalization)
    ...
    print('The corresponding accuracy for HardHFS is : {} %'.format(accuracy[0] * 100))
    print('The corresponding accuracy for SoftHFS is : {} %'.format(accuracy[1] * 100))
